            ...
            <div className="container">
                ...
                <div className="buttons">
                    <Button.Root bgcolor="#FFC019" className="top-button">
                        <ButtonControl className="text-button" type="submit">Editar Curso</ButtonControl>
                    </Button.Root>

                    <Button.Root bgcolor="#FFC019" className="top-button">
                        <ButtonControl className="text-button" type="submit">Ver curso</ButtonControl>
            ...
            <div className="classes">
                <div className="container">
                    ...
                    <Button.Root bgcolor="#FFC019" className="y-button">
                        <ButtonControl className="text-2-button" type="submit">Adicionar Aula</ButtonControl>
                    </Button.Root>
                </div>
