...
const ModalEditClass: React.FC = () => {
    ...
    return (
      ...
      <div className="button-with-label">
        <button
          className={`radial-button ${selectedButton === 0 ? 'selected' : ''}`}
      ...
      <div className="button-with-label">
        <button
          className={`radial-button ${selectedButton === 1 ? 'selected' : ''}`}
    ...
    <Button.Root bgcolor="#FFC019" className="add-button">
                        <ButtonControl className="add-button-text" type="submit">Adicionar</ButtonControl>
                    </Button.Root>
            ...
            <Button.Root bgcolor="#FFC019" className="exclude-button">
                        <ButtonControl className="exclude-button-text" type="submit">Excluir</ButtonControl>
                    </Button.Root>
